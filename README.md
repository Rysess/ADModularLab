...
| [`session`](ansible/modules/session/README.md) | windows | dc / child_dc / member | Logs a domain user on at the console (autologon), a live interactive session that holds a TGT. |
